...
interface Props {
    ...
    showLink: boolean
    setShowLink: (val:boolean)=> void;
    linkValue: string
    
}
const Alert:React.FC<Props> = ({responseMessage, setIsAlert, showLink, setShowLink, linkValue}) => {
   ...
   <strong className="font-bold">{showLink && <Link to={`/${linkValue}`}>{linkValue}</Link>}</strong>
