...
const TeamTable: React.FC<Props>  = ({update_id}) => {
    ...
    const columns = [
        ...
        {
            name: 'Name',
            selector: (row: any) => <Link to={`/team_members/${row.id}`} state={{team_lead_id: row.team_lead_id}}>{row.name}</Link>
        },
        {
            name: 'Description',
            selector: (row: ITeam) => row.description
        },
        {
            name: 'Team lead Id',
            selector: (row: ITeam) => row.team_lead_id
        },
        {
            name: 'Created at',
            selector: (row: ITeam) => row.created_at
        },
        {
            name: 'Company Id',
            selector: (row: ITeam) => row.company_id
        },
        {
            name: 'Updated at',
            selector: (row: ITeam) => row.updated_at
        },
        {
            name: 'Action',
