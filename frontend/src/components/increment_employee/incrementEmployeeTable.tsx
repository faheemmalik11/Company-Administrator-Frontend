...
const IncrementEmployeeTable = () => {
    ...
    const deleteHandlerInPopup = async (id:number | undefined, inc_id: number | undefined) => {
        setIsLoading(false)
        const response = await deleteIncrementHistoryById({ emp_id: id, id: inc_id});
...
export default IncrementEmployeeTable